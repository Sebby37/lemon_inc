...
pygame.display.set_icon(pygame.transform.scale(pygame.image.load("Assets/lemon.png").convert_alpha(), (32, 32)))
...
#Class Variables
backg = bg.Background(window)
lemon = Button(window, 25, 75, "Assets/Lemon.png", 400, 300)
AutoClick = Button(window, 450, 0, "Assets/Auto_Clicker_Button.png", 150, 150)
Lemonade = Button(window, 450, 150, "Assets/Lemonade_Button.png", 150, 150)
Double = Button(window, 450, 300, "Assets/Double_Button.png", 150, 150)
